...
const Payment = () => {
  ...
  const prices = {
    option1: 149.0,
    option2: 129.0 * 6, // Assuming a discount for 6 months
    option3: 99.0 * 12, // Assuming a discount for 1 year
  };
  ...
  const getFormattedPrice = () => {
    ...
    return (
      <h3 className="font-sans text-[#09080D] font-medium text-3xl sm:text-4xl tracking-[.2px]">
        $149.00<span className="text-[#8E8E93] text-sm">/Month</span>
      </h3>
    ); // Default value if selectedOption is not valid
  };
