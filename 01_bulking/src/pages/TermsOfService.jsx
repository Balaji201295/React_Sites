  ...
  <main className={`${styles.padding}`}>
    ...
    <div className="flex flex-col">
      ...
      <p className="font-sans text-sm font-normal tracking-[.16] mb-6">
        ...
        you, whether personally or on behalf of an entity (“you”) and Fitplan,
        Inc. ("Company," “we," “us," or “our”), concerning your access to and
        use of the https://www.company.com website as well as any other media
        ...
        are registered in California, United States and have our registered
        office at 401 30th St., NEWPORT BEACH, CA 92663. You agree that by
      ...
      <h3 className="font-sans text-xl sm:text-3xl font-semibold tracking-[.16] my-4">
